...
function isEvenNumber(num) {
  ...
  // Повернути результат перевірки (true або false) як результат функції  isEvenNumber(10);
  return num % 2 === 0;
}
...
// Задача 2: Напишіть функцію, яка обчислює суму
//чисел від 1 до заданого числа. Використовуйте цикл для послідовного додавання чисел.

function calculateSum(n) {
  // Ініціалізувати змінну sum зі значенням 0 Запустити цикл для змінної i від 1 до n
...
// console.log("isPositiveNumber(0)", isPositiveNumber(0)); // буде false
...
// Задача 7: Напишіть функцію findMax, яка приймає два числа num1 і num2 і повертає більше з них.
//Використовуйте умовний оператор if та оператор порівняння для визначення більшого числа.
...
// Задача 9: Напишіть функцію getDayOfWeek, яка приймає номер дня тижня dayNumber (1-7)
//і повертає рядок, що відповідає цьому дню тижня.
...
// Задача 10: Напишіть функцію getVariableType, яка приймає змінну variable і
//повертає рядок, що відповідає типу цієї змінної. Використовуйте тернарний оператор для визначення типу змінної.
...
function makeAdder(x) {
  // Вертаємо нову функцію, яка приймає `y` Сумуємо `x` та `y` і повертаємо результат
  return function (y) {
    return x + y;
  };
}
...
// Задача 14: Задача: створити каріровану функцію `divide`, яка може бути викликана
//як `divide(x)(y)`, щоб отримати результат ділення `x` на `y`.
...
// Створюємо змінну createCompose якій присвоємо результат виконання функції
//compose з аргументами increment та double
